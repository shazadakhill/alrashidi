...
import CreateEmployeeAccountModal from "../../modals/createEmployeeAccountModal/createEmployeeAccountModal"
    ...
    render() {
        ...
        return (
            <Container className="servicesSubServices">
                <CreateEmployeeAccountModal type="employees"></CreateEmployeeAccountModal>
                {users}
            </Container>
        )
    }
